By selecting an image file the application will generate a colour palette from the source image that can then be used to create a random grid of squares. 
